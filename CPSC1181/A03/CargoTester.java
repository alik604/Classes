...
public class CargoTester {
	...
	private static void testRemove() {
		...
		Cargo.Item[] items = new Cargo.Item[] { new Cargo.Item("", 4),
				new Cargo.Item("", 5), new Cargo.Item("", 6) };
	...
	private static void testGetHeaviest_Average() {
		Cargo cb;
		Cargo.Item[] items = new Cargo.Item[] { new Cargo.Item("", 0),
				new Cargo.Item("", 2), new Cargo.Item("", 4) };
	...
	private static void testGetHeaviest_Average_name() {
		Cargo cb;
		Cargo.Item[] items = new Cargo.Item[] { new Cargo.Item("a", 1),
				new Cargo.Item("b", 1), new Cargo.Item("a", 10),
				new Cargo.Item("a", 2) };
	...
	private static void testGetItems_tracking() {
		...
		Cargo.Item[] items = new Cargo.Item[] { new Cargo.Item("", 0),
				new Cargo.Item("", 1), new Cargo.Item("", 2),
				new Cargo.Item("", 3), };
		for (Cargo.Item i : items) {
			cb.add(i);
		}
	...
	private static void testGetItemsMap() {
		Cargo cb = new Cargo(10);
		Cargo.Item[] items = new Cargo.Item[] { new Cargo.Item("a", 0),
				new Cargo.Item("b", 1), new Cargo.Item("b", 2),
				new Cargo.Item("a", 3), };
		for (Cargo.Item i : items) {
			cb.add(i);
		}
