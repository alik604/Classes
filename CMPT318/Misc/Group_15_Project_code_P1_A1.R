...
sum((avgSWE_GAP_tr$x - avgSWE_GAP_te1$x)^2/2)
sum((avgSWE_GAP_tr$x - avgSWE_GAP_te2$x)^2/2)
sum((avgSWE_GAP_tr$x - avgSWE_GAP_te3$x)^2/2)
sum((avgSWE_GAP_tr$x - avgSWE_GAP_te4$x)^2/2)
sum((avgSWE_GAP_tr$x - avgSWE_GAP_te5$x)^2/2)

#compute errors between training and test data
sum((sdSWE_GAP_tr$x - sdSWE_GAP_te1$x)^2/2)
sum((sdSWE_GAP_tr$x - sdSWE_GAP_te2$x)^2/2)
sum((sdSWE_GAP_tr$x - sdSWE_GAP_te3$x)^2/2)
sum((sdSWE_GAP_tr$x - sdSWE_GAP_te4$x)^2/2)
sum((sdSWE_GAP_tr$x - sdSWE_GAP_te5$x)^2/2)