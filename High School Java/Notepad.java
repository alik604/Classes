...
public class Notepad extends JFrame {
    private static final JFrame fr = new JFrame("Notepad");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                text.setBorder(BorderFactory.createMatteBorder(2, 1, 1, 1, Color.BLACK));
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (fileopen == JFileChooser.APPROVE_OPTION) {
                            ...
                            try {
                                ...
                                Scanner scan = new Scanner(new FileReader(jfileopen.getSelectedFile().getPath()));

                                while (scan.hasNext()) text.append(scan.nextLine());
                            } catch (Exception ex) {
                ...
                save.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (filesave == JFileChooser.APPROVE_OPTION) {
                            try {
                                BufferedWriter out = new BufferedWriter(new FileWriter(jfilesave.getSelectedFile().getPath()));
