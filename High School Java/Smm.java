            ...
            try {
                switch (amplification) {
                    case 1:
                        ...
                        // url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe \"" + url[i]);
                        break;
                    // q.waitFor();
                    // dont open next till windows i closed, can be very useful
                    case 2:
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe \"--profile-directory=Profile1" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile2" + url[i]);
                        break;
                    case 3:
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe \"--profile-directory=Profile1" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile2" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile3" + url[i]);
                        break;
                    case 4:
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe \"--profile-directory=Profile1" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile2" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile3" + url[i]);
                        Runtime.getRuntime().exec("\"/Program Files (x86)/Google/Chrome/Application/chrome.exe\"--profile-directory=Profile4" + url[i]);
                ...
                System.out.println("Google Chrome launched, the url is: " + url[i]);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
