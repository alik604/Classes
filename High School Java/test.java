...
public class test {
    ...
    public static void main(String[] arguments) {
        ...
        layout.putConstraint(SpringLayout.SOUTH, send, -30, SpringLayout.SOUTH, contentPane);
        layout.putConstraint(SpringLayout.EAST, send, -30, SpringLayout.EAST, contentPane);

        layout.putConstraint(SpringLayout.NORTH, to, 20, SpringLayout.NORTH, contentPane);
        layout.putConstraint(SpringLayout.WEST, to, 30, SpringLayout.WEST, contentPane);

        layout.putConstraint(SpringLayout.SOUTH, bar, -30, SpringLayout.SOUTH, contentPane);
        layout.putConstraint(SpringLayout.WEST, bar, 30, SpringLayout.WEST, contentPane);
        /*
