 ...
 * @author kali
 * <p>
 * double for loop concept is not mine, I was aiming for an efficent way.
 * <p>
...
public class BubbleSortAlg {
    public static void main(String[] args) {
        ...
        int[] sortnumb = {(int) Math.ceil(letstryD), letstryI, (int) letstryD, 4, 66, 4, 0, 44, 33, 27, 85, 99, -11, 100 + 134, 200 * 2, 100};
