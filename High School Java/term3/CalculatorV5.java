 ...
 * f. "M²" means 2nd mem variable . this calculator term3.term3.term3.App has 2 mem variables (mem and mem1)
 */
...
public class CalculatorV5 {
    ...
    private static final JTextArea top = new JTextArea();
    private static final JScrollPane scroll = new JScrollPane(top);
    ...
    private static final DecimalFormat f = new DecimalFormat("##.00"); // decimal
    // points
    ...
    public static void main(String[] args) {
        ...
        top.setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, contentPane.getBackground()));
        ...
        final ActionListener equal_listener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (numb == null || numb.isEmpty()) return;
                EQUAL();
            }
        };
        ...
        final ActionListener print_listener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                PrintWriter out;
                try {
                    out = new PrintWriter(new BufferedWriter(new FileWriter(customDir + "/calc print out.txt")));
        ...
        final ActionListener paste_listener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    top.append(transfer.getTransferData(DataFlavor.stringFlavor) + "\n");
                } catch (Exception err) {
                    err.printStackTrace();
                }
        ...
        Ms.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                if (numb != null || numb.equals("")) try {
                    x = Double.parseDouble(numb);
                } catch (Exception i) {
                    System.out.println("numb is null, if seen i need it prevent error from happening");
                }
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                switch (e.getKeyCode()) {
                    case KeyEvent.VK_V:
                        paste_listener.actionPerformed(new ActionEvent(paste, 99990, null));
                        break;

                    case KeyEvent.VK_C:
                        copy_listener.actionPerformed(new ActionEvent(copy, 99990, null));
                        break;

                    case KeyEvent.VK_P, KeyEvent.VK_HOME :
                        print_listener.actionPerformed(new ActionEvent(print, 99990, null));
                        break;

                    case KeyEvent.VK_CLEAR:
                        ans_listener.actionPerformed(new ActionEvent(ans, 99990, null));
                        break;

                    case KeyEvent.VK_0, KeyEvent.VK_NUMPAD0:
                        zero_listener.actionPerformed(new ActionEvent(zero, 99990, null));
                        break;

                    case KeyEvent.VK_1, KeyEvent.VK_NUMPAD1:
                        one_listener.actionPerformed(new ActionEvent(one, 99990, null));
                        break;

                    case KeyEvent.VK_2, KeyEvent.VK_NUMPAD2:
                        two_listener.actionPerformed(new ActionEvent(two, 99990, null));
                        break;

                    case KeyEvent.VK_3, KeyEvent.VK_NUMPAD3:
                        three_listener.actionPerformed(new ActionEvent(three, 99990, null));
                        break;

                    case KeyEvent.VK_4, KeyEvent.VK_NUMPAD4:
                        four_listener.actionPerformed(new ActionEvent(four, 99990, null));
                        break;

                    case KeyEvent.VK_5, KeyEvent.VK_NUMPAD5:
                        five_listener.actionPerformed(new ActionEvent(five, 99990, null));
                        break;

                    case KeyEvent.VK_6, KeyEvent.VK_NUMPAD6:
                        six_listener.actionPerformed(new ActionEvent(six, 99990, null));
                        break;

                    case KeyEvent.VK_7, KeyEvent.VK_NUMPAD7:
                        seven_listener.actionPerformed(new ActionEvent(seven, 99990, null));
                        break;

                    case KeyEvent.VK_8, KeyEvent.VK_NUMPAD8:

                        if ((e.getModifiersEx() & KeyEvent.SHIFT_DOWN_MASK) != 0) {
                            multi_listener.actionPerformed(new ActionEvent(Multi, 99990, null));
                        } else {
                            eight_listener.actionPerformed(new ActionEvent(eight, 99990, null));
                        }

                        break;

                    case KeyEvent.VK_9, KeyEvent.VK_NUMPAD9:
                        nine_listener.actionPerformed(new ActionEvent(nine, 99990, null));
                        break;

                    case KeyEvent.VK_ADD:
                        plus_listener.actionPerformed(new ActionEvent(Plus, 99990, null));
                        break;

                    case KeyEvent.VK_DIVIDE:
                        divide_listener.actionPerformed(new ActionEvent(Divide, 99990, null));
                        break;
                    ...
                    case KeyEvent.VK_SUBTRACT:
                        minus_listener.actionPerformed(new ActionEvent(Minus, 99990, null));
                        break;
                    ...
                    case KeyEvent.VK_ENTER:
                        equal_listener.actionPerformed(new ActionEvent(Equal, 99990, null));
                        break;

                    case KeyEvent.VK_PERIOD, KeyEvent.VK_DECIMAL:
                        dec_listener.actionPerformed(new ActionEvent(Dec, 99990, null));
                        break;
    ...
    public static void EQUAL() {
        ...
        if (numb == null || numb.isEmpty() || co == null || co.isEmpty()) return;
