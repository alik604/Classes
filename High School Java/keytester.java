...
public class keytester extends JFrame {
    ...
    public keytester() {
        ...
        JScrollPane scrollbar1 = new JScrollPane(textArea1, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED); // VERTICAL_SCROLLBAR_ALWAYS
        // Automatically
        // scrolls down
