...
public class konverter {
	...
	public static void main(String args[]) {
		...
		do {
			System.out
					.println("please type 1 for binary to decimal converter, else type 2 or any alphanumeric characters (0 to quit): ");
	...
	public static void BinToInt() {
		...
		System.out
				.println("please enter a binary value you wish to convert to an int");
